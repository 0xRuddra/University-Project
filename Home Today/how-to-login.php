        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 sign-up" style="text-align: center;">
                    ...
                    <p><b>If you want to sign in as a tenant click on tenant login button otherwise click on owner login button.</b></p><br><br>
                    <button type="submit" class="btn btn-info"  onclick="window.location.href='renter-login.php'" style="width:200px;">Renter Login</button>
