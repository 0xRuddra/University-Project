...
function add_property(){
	...
	// $latitude=validate($_POST['latitude']);
        ...
        if(mysqli_num_rows($result1)>0)
      {
   	...
   	$sql = "INSERT INTO add_property (country,district,contact_no,property_type,estimated_price,total_rooms,bedroom,living_room,kitchen,bathroom,description,owner_id) VALUES('$country','$district','$contact_no','$property_type',
	   '$estimated_price','$total_rooms','$bedroom','$living_room','$kitchen','$bathroom','$description','$owner_id')";
