...
public class ViewHotels extends JFrame implements Runnable{
    ...
    public void run() {
        ...
        try {
            ...
            l2.setVisible(true);
            caption.setText("Sheraton Hotel");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Lakeshore Hotel");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("Sea Welcome Resort");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Ocean Paradise Hotel");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Grand Sultan Hotel");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Hotel Star Pacific");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
            caption.setText("Kuakata Grand Hotel");
            l8.add(caption);
            Thread.sleep(2800);
            l8.setVisible(false);
            l9.setVisible(true);
            caption.setText("Hotel Khan Palace");
            l9.add(caption);
            Thread.sleep(2800);
            l9.setVisible(false);
            l10.setVisible(true);
            caption.setText("Villa Jwi Hotel");
            l10.add(caption);
            Thread.sleep(2800);
            l10.setVisible(false);
            l11.setVisible(true);
            caption.setText("Homemage Hotel");
            l11.add(caption);
            Thread.sleep(2800);
    ...
    public ViewHotels() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/DH1.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/DH2.jpg"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/CH1.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/CH2.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/SH1.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons/SH2.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/Kuakatahotel1.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons/kuakata hotel22.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons/saintmartin hotel1.png"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/saint hotel2.jpg"));
