...
public class Destination extends JFrame implements Runnable{
    ...
    public Destination() {
        ...
        getContentPane().setBackground(new Color(220, 250, 250));/* picture size :900,480*/
        ImageIcon imgicon = new JImageIcon("design\\memorylabel.jpg");
        piclab1 = new JLabel("");
        piclab1.setBounds(0,0,400,200);
        add(piclab1);
        
       /* th = new Thread(this);

        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/dhaka1.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/Lalbagh Fort.png"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/coxs1.jpg"));
        ...
        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/coxs3.jpg"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/shylet.jpg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("icons/shylet1.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/kuakata.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("icons/kuakata2.jpg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("icons/saint-martin.jpg"));
        ...
        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/saintmartin1.jpg"));
