...
public class AboutSajek extends JFrame {
    ...
    AboutSajek(){
        ...
        img1 = new ImageIcon(getClass().getResource("design\\d_picture\\d_sajek.jpg"));
        ...
        underlbl = new JLabel("Sajak");
         underlbl.setBounds(390,175,100,25);
         underlbl.setForeground(Color.white);
         c.add(underlbl);
         
         img3 = new ImageIcon(getClass().getResource("design\\aboutPlaces\\sajek_info.jpg"));
	...
	m1.add(mi1);
        mi1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae){
                dispose();
                new SajekHotel().setVisible(true);
            }
        });
	...
	menuBar.add(m2);
        ...
        mi8.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae){
                try{
                  //dispose();
                 new SajekTransport().setVisible(true);
                }catch(Exception e){ }
            }
	});
    ...
    public static void main(String[] args) {
         ...
         AboutSajek frame = new  AboutSajek();
