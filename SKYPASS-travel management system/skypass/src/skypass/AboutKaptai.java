...
public class AboutKaptai extends JFrame {
	...
	menuBar.add(m1);
        ...
        JMenuItem mi1 = new JMenuItem("On Going Event Donation");
	m1.add(mi1);
	...
	menuBar.add(m6);
        ...
        m6.add(Event1);
           remain.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                new remainingFoodInfo().setVisible(true);
            }
	});
    ...
    public static void main(String[] args) {
         ...
         AboutKaptai frame = new  AboutKaptai();
