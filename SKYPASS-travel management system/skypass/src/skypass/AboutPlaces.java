...
public class AboutPlaces extends JFrame {
    private Container c;
    ...
    JScrollPane scroll;
     ...
     AboutPlaces(){
        ...
        img1 = new ImageIcon(getClass().getResource("design\\d_picture\\d_coxz.jpg"));
        ...
        underlbl = new JLabel("Cox's Bazar");
         underlbl.setBounds(390,175,100,25);
         underlbl.setForeground(Color.white);
         c.add(underlbl);
         
         img3 = new ImageIcon(getClass().getResource("design\\aboutPlaces\\coxs2.jpg"));
	...
	menuBar.add(m4);
     ...
     public static void main(String[] args) {
        AboutPlaces frame = new  AboutPlaces();
