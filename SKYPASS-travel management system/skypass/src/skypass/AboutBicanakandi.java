...
public class AboutBicanakandi extends JFrame {
    ...
    AboutBicanakandi(){
        ...
        img1 = new ImageIcon(getClass().getResource("design\\d_picture\\bicanakadni.jpg"));
        ...
        underlbl = new JLabel("Bichanakandi");
         underlbl.setBounds(390,175,100,25);
         underlbl.setForeground(Color.white);
         c.add(underlbl);
         
         img3 = new ImageIcon(getClass().getResource("design\\aboutPlaces\\B_info.jpg"));
	...
	m1.add(mi1);
        mi1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae){
                dispose();
                new BicanaHotel().setVisible(true);
            }
        });
	...
	menuBar.add(m2);
        JMenuItem mi8 = new JMenuItem("Details");
        m2.add(mi8);
        mi8.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae){
                try{
                  //dispose();
                 new BicanaTransport().setVisible(true);
                }catch(Exception e){ }
            }
	});
	...
	menuBar.add(m4);
        JMenuItem mi9 = new JMenuItem("Go");
        m4.add(mi9);
    ...
    public static void main(String[] args) {
         ...
         AboutBicanakandi frame = new  AboutBicanakandi();
