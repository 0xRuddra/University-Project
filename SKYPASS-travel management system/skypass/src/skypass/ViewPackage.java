...
public class ViewPackage extends JFrame {
    ...
    ViewPackage() {    
      ...
      setVisible(true);
      String[] package1 = new String[]{"package1.jpg","Bronze PACKAGE","6 days and 7 Nights", "Airport Assistance at Aiport", "Half Day City Tour", "Welcome drinks on Arrival", "Daily Buffet", " Car For Tour", "Tourist Guide", "BOOK NOW", "Summer Special", "Taka 12000 only"};
      String[] package2 = new String[]{"package2.jpg","SILVER PACKAGE","4 days and 3 Nights", "Airport Assistance at Airport", "Half Day City Tour", "Welcome drinks on Arrival", "Night Safari", "AC Car For Tour", "Tourist Guide", "BOOK NOW", "Winter Special", "Taka 9000 only"};
      String[] package3 = new String[]{"package3.jpg","GOLD PACKAGE","6 days and 5 Nights", "Return Airfare", "Free Clubbing, Horse Riding & other Games", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel", "BBQ Dinner", "BOOK NOW", "Winter Special", "Taka 32000 only"};
